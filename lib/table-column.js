...
/* harmony default export */ var table_column = ({
  ...
  methods: {
    ...
    setColumnForcedProps: function setColumnForcedProps(column) {
      ...
      var source = config["a" /* cellForced */][type] || {};
    ...
    setColumnRenders: function setColumnRenders(column) {
      ...
      var specialTypes = Object.keys(config["a" /* cellForced */]);
      ...
      if (column.type === 'expand') {
        ...
        originRenderCell = originRenderCell || config["c" /* defaultRenderCell */];
        // 对 renderCell 进行包装
        column.renderCell = function (h, data) {
          var children = null;
          ...
          var prefix = Object(config["e" /* treeCellPrefix */])(h, data);
          var props = {
            class: 'cell',
            style: {}
          };
    ...
    registerNormalWatchers: function registerNormalWatchers() {
      ...
      var props = ['label', 'property', 'filters', 'sortable', 'index', 'formatter', 'className', 'labelClassName', 'showOverflowTooltip'];
      // 一些属性具有别名
      var aliases = {
        prop: 'property',
        realAlign: 'align',
  ...
  created: function created() {
    ...
    var defaults = _extends({}, config["b" /* cellStarts */][type], {
      id: this.columnId,
      type: type,
    ...
    var filterProps = ['filterMethod', 'filterRemoteMethod', 'filters', 'filterOpened', 'filteredValue', 'filterPlacement'];
